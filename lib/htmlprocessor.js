...
//
var HTMLProcessor = module.exports = function (src, dest, content, revvedfinder, logcb, cacheBuster) {
  ...
  this.cacheBuster = cacheBuster || true; // @TODO: make this false
};
...
HTMLProcessor.prototype.replaceWith = function replaceWith(block) {
  ...
  if (this.cacheBuster) { dest + this.cacheBuster; }
